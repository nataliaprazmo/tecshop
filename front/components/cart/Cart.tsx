    ...
    if (isLoading) {
        return (
            <div className="w-full h-screen flex flex-col items-center justify-center">
                ...
                <p className="text-2xl font-semibold mt-4">Czyszczenie koszyka...</p>
            </div>
        );
    }
            ...
            <div className="w-full max-w-7xl mx-auto">
                <div className="flex justify-between items-center mb-10">
                    <h1 className="text-4xl font-bold mb-16">
                        Koszyk <span className="text-xl text-gray-700 font-normal ml-1">({totalItems} produkty)</span>
                    </h1>
                    <button
                ...
                <div 
                    className={`
                        ...
                        transition-all duration-500 
                        ${isClearing ? 'opacity-0 translate-y-10' : 'opacity-100 translate-y-0'}
                    `}
                >
                    ...
                    <div 
                        className={`
                            ...
                            transition-all duration-500
                            ${isClearing ? 'opacity-0 translate-y-5' : 'opacity-100 translate-y-0'}
                        `}
                    >
