...
import { getProducts, getProduct, createProductHandler, deleteProductHandler, getProductsByCategoryHandler, applyDiscountHandler, removeDiscountHandler } from "../controllers/product.controller";
